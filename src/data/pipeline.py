'''
Se llamanran  y ejecutaran todas las funciones para la ingesta de datos, la transformación de los datos, la creación de las tablas únicas de precios
