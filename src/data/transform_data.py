"""
De la ruta data_lake/landing/ tomamos el año y la extensión de los
archivos que se encuentran en esta ruta. 
Se cargaran los archivos de la ruta data_lake/landing/ reconociendo la diferencia de la 
columna fecha en formato YYYY-MM-DD y las horas desde H00 a H23.
Finalmente, se guardaran los archivos en la ruta data_lake/raw/ en formato csv.
